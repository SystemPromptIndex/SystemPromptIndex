---
id: "Cradle/Cradle_-_res_capcut_prompts_templates_task_inference"
company: "Cradle"
...
2. What is the current progress of the target task according to the analysis in question 1? Please do not make any assumptions if they are not mentioned in the above information. You should assume that you are doing the task from scratch. Please strictly follow the description and requirements in the current task.
